    ...
    <!-- Footer -->
    <footer class="text-center text-lg-start text-white" style="background-color: #01a89e">
      <!-- Grid container -->
        ...
        <section class="">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
              ...
              <p><i ></i> PetTinder@gmail.com</p>
              <p><i ></i> (+55) 18 99122- 4090</p>
              <br>
              <br>
               <img src="{{ asset('imagens/logo_fundo.png') }}" class="logo" alt="...">
