...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex" role="search">
            <a href="{{route('usuarios.create')}}"><button type="button" class="btn btn-success">Cadastrar-se</button></a>

            <a href="{{Route('usuarios.login')}}"> <button type="button" class="btn btn-info">Entrar</button></a>
          </form>
        </div>
      </div>
    </nav>
    ...
    <div class="col-11 m-auto">
       ...
       <h2 class="text-center">POR QUE ADOTAR?</h2>
       <p class="text-center"> Ao adotar um animal, que muitas vezes foi maltratado ou abandonado, você está dando ao pet um recomeço e uma oportunidade para ele ser amado. Muitas pessoas não percebem, mas os pets também têm sentimentos assim como nós, seres humanos. Eles sentem dor, tristeza, solidão e alegria. Assim, adotá-los é um ato de amor.
       </p>
   </div>
  <hr>
</body>
