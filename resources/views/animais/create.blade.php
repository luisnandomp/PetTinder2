            ...
            <form action="{{ route('animais.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <input id="raca" type="text" name="raca" placeholder="Raça do pet"
                            value="{{ old('raca') }}">
                        <!--required -->
                        @error('raca')
                    ...
                    <div class="input-box">
                        ...
                        <select name="porte" class="form-select form-select-lg mb-3"
                    ...
                    <div class="input-box">
                        ...
                        <input id="idade" type="number" name="idade" placeholder="Digite a idade"
                            value="{{ old('idade') }}">
                        <!--required -->
                        @error('idade')
                            <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="input-box">
                        ...
                        <input id="cor" type="text" name="cor" placeholder="Digite a Cor"
                            value="{{ old('cor') }}">
                        <!--required -->
                        @error('cor')
                            <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="input-box">
                        ...
                        <select name="personalidade" class="form-select form-select-lg mb-3"
                            aria-label=".form-select-lg example">
                    ...
                    <div class="input-group">
                        <div class="input-box">
                            ...
                            <select name="comorbidade" class="form-select form-select-lg mb-3"
                                aria-label=".form-select-lg example">
                    ...
                    <div class="input-box">
                        ...
                        <input id="apelido" type="text" name="apelido" placeholder="Digite o apelido"
                            value="{{ old('apelido') }}">
                        <!--required -->
                        @error('apelido')
                            <div class="alert alert-danger">{{ $message }}</div>
                ...
                <div class="input-group">
                    ...
                    <div class="gender-inputs">
                        ...
                        <div class="gender-group">
                            <div class="gender-input">
                                <input class="select" type="radio" id="sim" name="castracao"
                                    value="sim">
                                <label for="sim">Sim</label>
                            </div>
                            <div class="gender-input">
                                <input class="select" type="radio" id="nao" name="castracao"
                                    value="nao">
                    ...
                    <div class="input-box">
                        ...
                        <input id="localidade" type="text" name="localidade" placeholder="Digite a localidade"
