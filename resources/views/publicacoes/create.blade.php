            ...
            <form action="{{ route('publicacoes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <textarea id="descricao" type="text" name="descricao" placeholder="Descreva o seu Animal">{{ old('descricao') }}</textarea>
                        <!--required -->
                        ...
                        @foreach ($animais as $animal)
                            <div class="d-flex flex-column flex-row justify-content-center align-items-center gap-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="id_animal" id="id_animal"
                                        value="{{ $animal->id }}" checked>
