        ...
        <div class="d-flex flex-row align-items-center">
            ...
            <div class="conteudo">
                ...
                <h2 class="objetivo">
                    ...
                    Com isso o objetivo do sistema é gerenciar e facilitar a adoção e a encontrar seu animal, seja resgatando ou pela adoção responsável. O Sistema possui a opção da interação entre os usuários fazendo postagens e por publicações, com o intuito de facilitar a comunicação entre os usuários.
                </h2>
            </div>
        </div>
    </div>
